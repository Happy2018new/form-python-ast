...
const HOVER_DOCS = new Map<string, string>([
    ...
    ["selector", "Selector 语句。语法: `{selector, <target: str>}`"],
    ["score", "Score 语句。语法: `{score, <player: str>, <scoreboard: str>}`"],
    ["command", "Command 语句。语法: `{command, <commandLine: str>}`"],
    ["ref", "Ref 语句。语法: `{ref, <dataType: type>, <index: int>}`"],
    ["func", "Func 语句。语法: `{func, funcName(arg1, arg2, ..., argN)}`"],
    ["and", "逻辑与运算。"],
    ["or", "逻辑或运算。"],
    ["not", "逻辑取反运算。"],
    ["in", "成员检查运算。"],
