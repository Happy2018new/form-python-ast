...
# 概述
**Form Python AST** 是完全通过纯 **Python** 开发的基于 **Virtual Machine** 的解释器。<br/>
它定义了一种脚本语言，允许您解析源代码为 **AST** 语法树，并将其编译为虚拟机字节码，然后解释执行。
...
| 解释器      | 0.05s 内解析次数 | 0.05s 内运行次数 | 1s 内运行次数 | 单次运行的操作次数 | 操作次数/秒 |
| ----------- | ---------------- | ---------------- | ------------- | ------------------ | ----------- |
| Python 3.14 | 2896.51          | 72042.62         | 1440852.4     | 3                  | 4.32 M/s    |
| Python 2.7  | 1450.20          | 54562.02         | 1091240.4     | 3                  | 3.27 M/s    |
| PyPy 2.7    | 51029.13         | 765443.89        | 15308877.8    | 3                  | 45.93 M/s   |
...
| 解释器      | 0.05s 内解析次数 | 0.05s 内运行次数 | 1s 内运行次数 | 单次运行的操作次数 | 操作次数/秒 |
| ----------- | ---------------- | ---------------- | ------------- | ------------------ | ----------- |
| Python 3.14 | 2076.87          | 55085.34         | 1101706.8     | 5                  | 5.51 M/s    |
| Python 2.7  | 1011.56          | 36988.59         | 739771.8      | 5                  | 3.70 M/s    |
| PyPy 2.7    | 35613.90         | 642487.09        | 12849741.8    | 5                  | 64.25 M/s   |
...
| 解释器      | 0.05s 内解析次数 | 0.05s 内运行次数 | 1s 内运行次数 | 单次运行的操作次数 | 操作次数/秒 |
| ----------- | ---------------- | ---------------- | ------------- | ------------------ | ----------- |
| Python 3.14 | 403.37           | 895.04           | 17900.8       | 610                | 10.92 M/s   |
| Python 2.7  | 228.02           | 669.45           | 13389.0       | 610                | 8.17 M/s    |
| PyPy 2.7    | 4888.81          | 13893.30         | 277866.0      | 610                | 169.50 M/s  |
...
| 解释器      | 0.05s 内解析次数 | 0.05s 内运行次数 | 1s 内运行次数 | 单次运行的操作次数 | 操作次数/秒 |
| ----------- | ---------------- | ---------------- | ------------- | ------------------ | ----------- |
| Python 3.14 | 166.55           | 1281.09          | 25621.8       | 438                | 11.22 M/s   |
| Python 2.7  | 95.03            | 896.61           | 17932.2       | 438                | 7.85 M/s    |
| PyPy 2.7    | 2163.09          | 18028.67         | 360573.4      | 438                | 157.93 M/s  |
...
| 解释器      | 0.05s 内解析次数 | 0.05s 内运行次数 | 1s 内运行次数 | 单次运行的操作次数 | 操作次数/秒 |
| ----------- | ---------------- | ---------------- | ------------- | ------------------ | ----------- |
| Python 3.14 | 115.49           | 2211.28          | 44225.6       | 210                | 9.29 M/s    |
| Python 2.7  | 64.70            | 1702.45          | 34049.0       | 210                | 7.15 M/s    |
| PyPy 2.7    | 1466.94          | 30681.51         | 613630.2      | 210                | 128.86 M/s  |